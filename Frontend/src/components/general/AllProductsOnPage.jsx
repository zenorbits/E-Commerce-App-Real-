    ...
    const products = [
        {
            ...
            stock: 25,
            image:
                "https://m.media-amazon.com/images/G/31/img22/CEPC/Jupiter/Sony/WH-1000XM6_Amazon_1400x800._CB799557079_.jpg",
        },
        {
            id: 2,
                  ...
                  transform transition duration-300 hover:scale-105 hover:shadow-2xl"
                            >
                                ...
                                <div className="p-4 flex flex-col gap-2 text-white">
                                    ...
                                    {/* View More Button (UI only) */}
                                    <button
                                        className="mt-3 px-4 py-2 bg-indigo-600 text-white text-sm font-semibold rounded-lg shadow-md hover:bg-indigo-700 transition duration-300"
                                    >
                                        View More
                                    </button>
                                </div>
